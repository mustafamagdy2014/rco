...
export class AppComponent implements OnDestroy, OnInit {
    ...
    constructor(public renderer: Renderer, public zone: NgZone,private appService:AppService,private userService:UserService,private sharedService:SharedService) {}

    ngOnInit() {
      this.zone.runOutsideAngular(() => {this.bindRipple(); });
      this.isRTL=true;
      this.errorOccurred();
      this.globalMessageEvent();
    }

    errorOccurred(){
        this.sharedService.errorOccurred.subscribe(err=>{
    ...
    globalMessageEvent(){
        this.sharedService.globalMessageEvent.subscribe(response=>{
            this.msgs=[];
            this.msgs.push({severity:response["type"], detail:response["message"]});
        });
    }
